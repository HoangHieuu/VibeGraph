...
| US-604 | Public npm package resolves and launches through the scoped npx command | no | yes | no | no | in_progress | npm publish dry-run passed for 0.1.0; actual publication blocked by ENEEDAUTH |
